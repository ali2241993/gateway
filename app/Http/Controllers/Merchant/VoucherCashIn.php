...
class VoucherCashIn extends Controller{
    public function voucherCashIn(Request $request){
        try{
            ...
            $response = Http::post('http://127.0.0.1:8001/api/merchant/voucherCashIn',$request->all());
            return $response;
        }
        catch(\exception $e){
            return $e;
