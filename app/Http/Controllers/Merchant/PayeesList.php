...
class PayeesList extends Controller{
    public function payeesList(Request $request){
        try{
            ...
            $response = Http::post('http://127.0.0.1:8001/api/merchant/getPayeesList',$request->all());
            return $response;
        }
        catch(\exception $e){
            return $e;
