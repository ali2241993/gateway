...
class BillPrepayment extends Controller{
    public function billPrepayment(Request $request){
        try{
            $validator = Validator::make($request->all(), [
                ...
                'personalPaymentInfo'    => 'required|string',
            ...
            $response = Http::post('http://127.0.0.1:8001/api/merchant/prepayBill',$request->all());
            return $response;
        }
        catch(\exception $e){
            return $e;
